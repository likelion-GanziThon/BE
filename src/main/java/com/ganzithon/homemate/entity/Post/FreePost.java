...
public class FreePost {
    ...
    private FreePost(Long userId, String title, String content,
    ...
    public static FreePost create(Long userId, CreatePostRequest req) {
        return new FreePost(
                userId,
                req.getTitle(),
                req.getContent(),
    ...
    public List<FreePostImage> getImages() {
        return images;
    }
